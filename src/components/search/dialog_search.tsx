...
const DataTest = [
	{
		...
		code: 'BIDV-BID10117',
		avata: 'https://image.bnews.vn/MediaUpload/Org/2022/04/26/logo-bidv-20220426071253.jpg',
		avata_alert: 'BID',
	...
	return (
		<div>
			<Dialog defaultOpen={false}>
				...
				<DialogContent className="sm:max-w-[425px] lg:max-w-prose h-1/2 fixed top-1/3">
					<DialogHeader>
					...
					<Separator />
					<div className="flex flex-col py-4 overflow-y-scroll">
						{DataTest.map((item, index) => {
							if (item.name.includes(keySearch)) {
								return (
									<div
										className="flex items-center gap-4 hover:bg-slate-100 p-2"
										key={index}
									>
